...
用法：
    ...
    python3 testing/l3/windows/theme_switch.py --dark --app path/to/Rhythm.exe
    python3 testing/l3/windows/theme_switch.py --light --app ...
    （所有模式支持 --log PATH，默认 testing/logs/theme_switch.log）
...
def main() -> int:
    ...
    ap.add_argument("--log", type=Path, default=None,
                    help="日志文件（默认 testing/logs/theme_switch.log，覆盖写入）")
    args = ap.parse_args()
