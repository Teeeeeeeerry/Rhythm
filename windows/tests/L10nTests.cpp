...
TEST_CASE("LK-03 L10n playback failure classification has English branches") {
    {
        ...
        // #226: the kind crossing the seam is the core's own value; an
        // empty kind (non-HTTP failure) reads as the generic copy.
        REQUIRE(L10n::PlaybackFailed(L"", L"detail") == generic);
    }
    {
        LanguageScope zh(L"zh");
        auto expired = L10n::PlaybackFailed(L"expired", L"detail");
